# A simple Dashboard with Tailwind CSS Project
...
> [Dashboard example](https://github.com/4GeeksAcademy/ai-engineering-syllabus/blob/main/content/projects/simple-dashboard-tailwind-css/.learn/solution.png)
